ADMIN_VERB_ADD(/datum/admins/proc/map_template_load, R_DEBUG, FALSE)
ADMIN_VERB_ADD(/datum/admins/proc/map_template_load_new_z, R_DEBUG, FALSE)
ADMIN_VERB_ADD(/datum/admins/proc/map_template_upload, R_DEBUG, FALSE)
...
/datum/admins/proc/map_template_load()
	...
	for(var/S in template.get_affected_turfs(T,centered = TRUE))
		preview += image('icons/effects/liquid.dmi',S,"2")
